...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Source+Sans+3:ital,wght@0,300;0,400;0,500;0,600;1,400&family=Source+Serif+4:ital,opsz,wght@0,8..60,400;0,8..60,500;0,8..60,600;1,8..60,400&display=swap",
      },
    ],
  }),
  component: Landing,
  ...
  return (
    <div className="min-h-screen font-sans text-cream">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-espresso/80 backdrop-blur-md border-b border-stone-line">
        <div className="mx-auto flex max-w-[1400px] items-center justify-between px-6 py-4 sm:px-10">
          <a href="#top" className="flex items-baseline gap-2">
            <span className="font-serif text-2xl text-cream">Aura</span>
      ...
      <section id="top" className="relative pt-28 sm:pt-32">
          ...
          <div className="grid grid-cols-12 gap-x-6 gap-y-10">
            <div className="col-span-12 lg:col-span-7">
              ...
              <h1 className="mt-8 font-serif text-[3.25rem] leading-[0.95] text-cream sm:text-[5rem] lg:text-[6.5rem]">
                A small roastery,<br />
                <span className="text-cream-dim">and a very</span> quiet room.
              </h1>
        ...
        {/* MARQUEE */}
        <div className="mt-16 overflow-hidden border-y border-stone-line py-4 sm:mt-20">
          <div className="flex w-max animate-marquee gap-16 whitespace-nowrap text-sm text-cream-dim">
            {[...MARQUEE_ITEMS, ...MARQUEE_ITEMS, ...MARQUEE_ITEMS, ...MARQUEE_ITEMS].map((t, i) => (
              <span key={i} className="flex items-center gap-16">
                <span className="font-serif text-cream">{t}</span>
          ...
          <div className="grid grid-cols-12 gap-x-6 gap-y-10">
            <div className="col-span-12 lg:col-span-4 lg:sticky lg:top-32 lg:self-start">
              ...
              <h2 className="mt-4 font-serif text-5xl leading-[0.95] text-cream sm:text-6xl">
                What's on
                <br />
                <span className="text-cream-dim">the bar</span> today.
              </h2>
              ...
              <div className="mt-10 flex flex-wrap gap-x-6 gap-y-2 border-t border-stone-line pt-6">
                {TABS.map((t) => (
                  <button
                    key={t}
                    onClick={() => setTab(t)}
                    className={`ink-link text-left font-serif text-2xl transition-colors ${
        ...
        <div className="mx-auto max-w-[1400px] px-6 sm:px-10">
          <div className="grid grid-cols-12 gap-x-6 gap-y-10">
            ...
            <div className="col-span-12 lg:col-span-6 lg:col-start-7">
              ...
              <h2 className="mt-4 font-serif text-5xl leading-[0.95] text-cream sm:text-6xl">
                We started with
                <span className="text-cream-dim"> one bag </span>
                of beans and
                <span className="text-cream-dim"> a borrowed grinder.</span>
              </h2>
              <div className="mt-8 space-y-5 text-[15px] leading-relaxed text-cream-dim">
                ...
                <p className="italic font-serif text-cream">
                  We're a small shop. We plan to stay small.
                </p>
              </div>

              <dl className="mt-10 grid grid-cols-3 gap-6 border-t border-stone-line pt-8">
                {[
                  ...
                  <div key={s.v}>
                    <dt className="font-serif text-4xl text-cream">{s.k}</dt>
      ...
      {/* THE SPACE — aligned rows on every breakpoint */}
      <section id="space" className="relative py-20 sm:py-28">
        <div className="mx-auto max-w-[1400px] px-6 sm:px-10">
          <div className="max-w-2xl">
            <div className="text-[11px] uppercase tracking-[0.35em] text-amber">The space</div>
            <h2 className="mt-4 font-serif text-5xl leading-[0.95] text-cream sm:text-6xl">
              Come in. <span className="text-cream-dim">Stay a while.</span>
            </h2>
          </div>
          ...
          <div className="mt-14 space-y-12 sm:space-y-14">
            {[
              ...
              <article
                key={f.num}
                className="grid grid-cols-[4.5rem_minmax(0,1fr)] items-start gap-x-4 gap-y-3 sm:grid-cols-[5.5rem_minmax(0,1fr)_14rem] sm:gap-x-8 lg:grid-cols-[6.5rem_minmax(0,1fr)_16rem]"
              >
                <div className="font-serif text-5xl leading-none text-amber sm:text-6xl lg:text-7xl">
                  {f.num}
                </div>
                <div className="min-w-0">
                  <h3 className="font-serif text-3xl text-cream sm:text-4xl">{f.title}</h3>
                  <p className="mt-3 max-w-lg text-[15px] leading-relaxed text-cream-dim sm:mt-4">
                    {f.copy}
                  </p>
                </div>
                <div className="col-start-2 border-l border-amber/40 pl-4 sm:col-start-3 sm:self-start">
                  <p className="text-xs text-cream-dim">— {f.aside}</p>
                </div>
              </article>
            ))}
          </div>
      ...
      {/* NOTES FROM REGULARS — equal columns, same edge on all screens */}
        ...
        <div className="mx-auto max-w-[1400px] px-6 sm:px-10">
          <div className="max-w-xl">
            ...
            <h2 className="mt-4 font-serif text-4xl leading-tight text-cream sm:text-5xl">
              Left by <span className="text-cream-dim">people who came back.</span>
            </h2>
          </div>

          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-x-8 md:gap-y-0">
            {[
              {
              ...
              <figure
                key={t.who}
                className="flex h-full flex-col border-t border-stone-line pt-6"
              >
                ...
                <blockquote className="mt-4 flex-1 font-serif text-2xl italic leading-snug text-cream sm:text-[1.65rem]">
                  "{t.q}"
                </blockquote>
          ...
          <div className="grid grid-cols-12 gap-x-6 gap-y-10">
            <div className="col-span-12 lg:col-span-6">
              ...
              <h2 className="mt-4 font-serif text-5xl leading-[0.95] text-cream sm:text-7xl">
                Drop by for a <span className="text-cream-dim">pour-over,</span>
                <br />
                or stay for the <span className="text-cream-dim">ambient noise.</span>
              </h2>

              <div className="mt-10 grid grid-cols-2 gap-x-6 gap-y-8 border-t border-stone-line pt-8">
                <div>
                ...
                <div>
                  ...
                  <div className="mt-2 font-serif text-xl text-cream">Sundays, 11am</div>
                  <div className="text-sm text-cream-dim">Walk-ins welcome.</div>
                </div>
              </div>

              {/* newsletter — inline, editorial */}
              <div className="mt-12 border-t border-stone-line pt-8">
            ...
            {/* offset map */}
            <div className="relative col-span-12 lg:col-span-5 lg:col-start-8 lg:mt-12">
      ...
      {/* FOOTER */}
      <footer className="border-t border-stone-line py-12">
        <div className="mx-auto max-w-[1400px] px-6 sm:px-10">
          <div className="grid grid-cols-12 items-end gap-y-8">
            <div className="col-span-12 md:col-span-5">
              <div className="font-serif text-5xl text-cream">Aura.</div>
            ...
            <div className="col-span-6 md:col-span-4 md:text-right">
              <p className="text-xs text-cream-dim">
                Handset in Source Serif 4 & Source Sans 3.
                <br />
